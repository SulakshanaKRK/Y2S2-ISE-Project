<%-- 
    Document   : index2
    Created on : Apr 14, 2024, 6:56:41 PM
    Author     : Sithumini
--%>
...
<body>
    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="/SalonSIlkyHair/deleteMyprofileServlet">My profile</a></li>
    ...
    <section class="sectionFirst">
        <div class="frontPage">
            ...
            <div class="btn">
                <a href="services.html">Get Gorgeous</a>
    ...
    <section class="sectionSecond">
        ...
        <div class="textInfo">
            ...
            <a href="protfolio.html" class="btn">Know More</a>
        </div>
    </section>
