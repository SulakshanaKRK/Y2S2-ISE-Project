<%-- 
    Document   : checkPromoValidity
    Created on : May 11, 2024, 9:28:30 PM
    Author     : Sithumini
--%>
...
<html lang="en">
    <head>
        ...
        <title>Check Promotion Validity</title>
            ...
            <div id="layoutSidenav_content">
                <main class="main">
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Check Promotion Validity</h1>
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Check Promotion Validity</li>
            ...
            <section class="table__body">
                <table>
                    <thead>
                     ...
                     <% ArrayList<promotions> pr2Array = (ArrayList) request.getAttribute("pr2Array");
                for (promotions pr2 : pr2Array) { %>  
                  
                        <tr>
                            <td><%= pr2.getPromo_code() %></td>
                            <td><%= pr2.getPromo_type() %></td>
                            <td><%= pr2.getValid_period() %></td>
                        </tr>
                         <% }%>  
