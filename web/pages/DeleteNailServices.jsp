...
<html lang="en">
    <head>
        ...
        <title>Delete Nail Services</title>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="delete-nail-service">Delete Beauty Service</a>
                ...
                <main class="main">
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Service Handling</li>
                            <li class="breadcrumb-item active">Delete Beauty Services</li>
                        </ol>

                    </div>

                    <div class="addServices">
                        <form action="delete-nail-service" method="POST">
                            <div>
                            ...
                            <div>
                                <button type="submit" id="deleteButton" onclick="openDeleteModal">Delete</button>
